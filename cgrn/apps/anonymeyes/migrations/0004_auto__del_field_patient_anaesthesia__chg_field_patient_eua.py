...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('anonymeyes_patient', 'eua_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cndapp.Anaesthesia']))
    ...
    def backwards(self, orm):
        ...
        db.add_column('anonymeyes_patient', 'anaesthesia',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cndapp.Anaesthesia'], null=True, blank=True),
                      keep_default=False)
