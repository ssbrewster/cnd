...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('anonymeyes_outcome', 'tonometry',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cndapp.Tonometry']),
                      keep_default=False)

        # Adding field 'Outcome.eua'
        db.add_column('anonymeyes_outcome', 'eua',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cndapp.Anaesthesia']),
                      keep_default=False)
