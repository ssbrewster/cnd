...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('anonymeyes_patient', 'visual_acuity_correction_left_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cndapp.VisualAcuityCorrection']))

        # Changing field 'Patient.visual_acuity_both'
        db.alter_column('anonymeyes_patient', 'visual_acuity_both_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cndapp.VisualAcuityReading']))

        # Changing field 'Patient.visual_acuity_correction_right'
        db.alter_column('anonymeyes_patient', 'visual_acuity_correction_right_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cndapp.VisualAcuityCorrection']))

        # Changing field 'Outcome.visual_acuity_correction_left'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_correction_left_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cndapp.VisualAcuityCorrection']))

        # Changing field 'Outcome.visual_acuity_both'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_both_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cndapp.VisualAcuityReading']))

        # Changing field 'Outcome.visual_acuity_correction_right'
        db.alter_column('anonymeyes_outcome', 'visual_acuity_correction_right_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cndapp.VisualAcuityCorrection']))
