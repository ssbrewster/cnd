...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('anonymeyes_visualacuitymethod_scales', (
            ...
            ('visualacuitymethod', models.ForeignKey(orm['cndapp.visualacuitymethod'], null=False)),
            ('visualacuityscale', models.ForeignKey(orm['cndapp.visualacuityscale'], null=False))
        ))
