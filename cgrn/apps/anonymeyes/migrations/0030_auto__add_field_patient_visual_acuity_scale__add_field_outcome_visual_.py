...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('anonymeyes_patient', 'visual_acuity_scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='patient_visualacuity_scale', to=orm['cndapp.VisualAcuityScale']),
                      keep_default=False)

        # Adding field 'Outcome.visual_acuity_scale'
        db.add_column('anonymeyes_outcome', 'visual_acuity_scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='outcome_visualacuity_scale', to=orm['cndapp.VisualAcuityScale']),
                      keep_default=False)
    ...
    models = {
        ...
        'cndapp.management': {
            ...
            'agents': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cndapp.IOPAgents']", 'null': 'True', 'blank': 'True'}),
