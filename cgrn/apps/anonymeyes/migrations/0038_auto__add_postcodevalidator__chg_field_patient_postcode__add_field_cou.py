...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cndapp', ['PostcodeValidator'])
        ...
        db.add_column('anonymeyes_country', 'postcode_validator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cndapp.PostcodeValidator']),
                      keep_default=False)
    ...
    models = {
        ...
        'cndapp.country': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'postcode_validator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cndapp.PostcodeValidator']"}),
            'sort': ('django.db.models.fields.IntegerField', [], {'default': '10'})
        },
        'cndapp.diagnosis': {
        ...
        'cndapp.management': {
            ...
            'agents': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['cndapp.IOPAgent']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'cndapp.userprofile': {
            ...
            'dob_min_precision': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'+'", 'to': "orm['cndapp.DOBPrecision']"}),
            'dob_precision': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'+'", 'to': "orm['cndapp.DOBPrecision']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
