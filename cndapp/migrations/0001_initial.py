    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('able_to_lie_flat', models.BooleanField(default=None, choices=[(True, 'Yes'), (False, 'No')])),
                ('guarded_prognosis', models.BooleanField(default=None, choices=[(True, 'Yes'), (False, 'No')])),
                ...
                ('iol_power', models.DecimalField(verbose_name=b'IOL power', max_digits=4, decimal_places=2)),
